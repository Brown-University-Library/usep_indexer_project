...
TEMP_UNIFIED_INSCRIPTIONS_DIR_PATH = pathlib.Path(os.environ['TEMP_UNIFIED_INSCRIPTIONS_DIR_PATH'])
...
SOLR_INDEX_BATCH_SIZE = int(os.environ.get('SOLR_INDEX_BATCH_SIZE', '100'))
SOLR_COMMIT_WITHIN_MS = int(os.environ.get('SOLR_COMMIT_WITHIN_MS', '500'))
SOLR_TIMEOUT_SECONDS = float(os.environ.get('SOLR_TIMEOUT_SECONDS', '30'))
