...
- `/list_orphans/` deliberately omits configured filesystem and Solr locations from its HTML/JSON context. Preserve that information-disclosure boundary when changing the response context or template.
