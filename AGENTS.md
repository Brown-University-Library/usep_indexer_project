...
- `/list_orphans/` includes configured filesystem and Solr locations in its HTML/JSON context. Treat changes to this response as both compatibility and information-exposure decisions.
